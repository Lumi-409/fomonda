  ...
  return (
    <div className="relative isolate flex flex-1 flex-col overflow-hidden bg-white">
      ...
      <div className="flex flex-1 flex-col items-center justify-center gap-4xl px-[40px] py-4xl">
        ...
        <div className="flex w-full min-w-[292px] flex-col">
          ...
          <p className="mt-[48px] text-center text-eyebrow text-gray-400">
            포몬다는 투자 판단을 대신하지 않아요.
            <br />
            본 서비스에서 제공하는 정보는 참고용이며, 투자에 대한 최종 책임은 본인에게 있어요.
          </p>
        </div>
      </div>
    </div>
