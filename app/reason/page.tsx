  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      <div className="flex flex-1 flex-col px-lg py-2xl">
        ...
        {previousJudgment && (
          <div className="mt-[32px] flex flex-col gap-xs rounded-card bg-gray-50 p-lg">
        ...
        <div
          className={`flex w-full flex-col rounded-input border border-gray-200 bg-white px-[20px] py-[16px] focus-within:border-gray-800 ${previousJudgment ? "mt-[16px]" : "mt-[32px]"}`}
        >
          <textarea
            value={reasonText}
        ...
        <div className="mt-[32px] flex flex-col gap-lg">
      ...
      <div className="sticky bottom-0 flex flex-col gap-sm bg-white px-lg pb-2xl pt-lg">
